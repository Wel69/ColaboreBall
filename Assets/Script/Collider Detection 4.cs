...
public class ColliderDetection4 : MonoBehaviour
{
    public Main main;
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.GetComponentInChildren<Renderer>().material.color == Color.green)
        {
            main.CollisionDetectedGreen();
        }
        else
        {
