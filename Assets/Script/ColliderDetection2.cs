...
public class ColliderDetection2 : MonoBehaviour
{
    public Main main;
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.GetComponentInChildren<Renderer>().material.color == Color.yellow)
        {
            main.CollisionDetectedYellow();
        }
        else
        {
